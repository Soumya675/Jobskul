    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-8">
      ...
      <div className="bg-linear-to-r from-blue-700 via-blue-800 to-indigo-900 rounded-2xl p-6 sm:p-8 text-white shadow-md relative overflow-hidden">
        <div className="relative z-10 flex flex-col md:flex-row md:items-center md:justify-between gap-6">
          ...
          <div className="bg-white/10 backdrop-blur-md rounded-xl p-4 sm:p-5 border border-white/20 min-w-[260px]">
              ...
              >
                ...
                <div className="flex items-center space-x-3 pt-2">
                  ...
                  <button
                    ...
                    className="px-3 py-2 bg-white hover:bg-slate-100 border border-slate-200 text-blue-700 rounded-lg text-xs font-semibold flex items-center space-x-1 transition-colors"
                  >
          ...
          <div className="pt-2 space-y-2">
            ...
            >
              <div className="flex items-center space-x-2">
                ...
                <span>Jobskül HireAI Career Engine</span>
              </div>
              <ArrowRight className="w-3.5 h-3.5 text-slate-400" />
            </button>
          </div>
